 ...
 * @LastEditTime: 2021-06-28 18:50:25
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /domh/ompWeb/src/layouts/CustomBreadcrumb/index.js
 */
    ...
    <div className={styles.customNav}>
      ...
      {location.pathname?.includes("/homepage") ? (
        <>
          ...
          <span className={styles.timeStampContainer} style={{paddingRight:20}}>
            刷新时间: {curentTime}
          </span>
        </>
      ) : (
